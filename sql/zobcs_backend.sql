...
--
-- Host: localhost
-- Generation Time: Mar 29, 2015 at 05:30 PM
...
-- Procedures
--
CREATE DEFINER=`zobcs`@`localhost` PROCEDURE `add_jobs_esync`()
    MODIFIES SQL DATA
BEGIN
...
`build_job_id` int(11) NOT NULL,
  ...
  `status` enum('Waiting','Building') NOT NULL DEFAULT 'Waiting',
  `build_now` tinyint(1) NOT NULL DEFAULT '0',
  `removebin` tinyint(1) NOT NULL,
  `time_stamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=MyISAM AUTO_INCREMENT=3114 DEFAULT CHARSET=utf8 COMMENT='The build work list';
...
) ENGINE=MyISAM AUTO_INCREMENT=147 DEFAULT CHARSET=utf8 COMMENT='Build jobs that need to be redone';
...
`build_log_id` int(11) NOT NULL,
  ...
  `time_stamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=MyISAM AUTO_INCREMENT=10892 DEFAULT CHARSET=utf8 COMMENT='Main log info for the builds';
...
`log_id` int(11) NOT NULL,
  ...
  `time_stamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=MyISAM AUTO_INCREMENT=37427 DEFAULT CHARSET=utf8;
...
) ENGINE=MyISAM AUTO_INCREMENT=249211 DEFAULT CHARSET=utf8;
...
) ENGINE=MyISAM AUTO_INCREMENT=47834 DEFAULT CHARSET=utf8;
...
`category_id` int(11) NOT NULL,
  ...
  `time_stamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=MyISAM AUTO_INCREMENT=180 DEFAULT CHARSET=utf8 COMMENT='Categories main table (C)';
...
`ebuild_id` int(11) NOT NULL,
  ...
  `active` tinyint(1) NOT NULL DEFAULT '0',
  `time_stamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=MyISAM AUTO_INCREMENT=70672 DEFAULT CHARSET=utf8 COMMENT='Version main table (V)';
...
`id` int(11) NOT NULL,
  ...
  `use_id` int(11) NOT NULL,
  `status` tinyint(1) NOT NULL
) ENGINE=MyISAM AUTO_INCREMENT=374659 DEFAULT CHARSET=utf8;
...
) ENGINE=MyISAM AUTO_INCREMENT=473503 DEFAULT CHARSET=utf8;
...
) ENGINE=MyISAM AUTO_INCREMENT=70672 DEFAULT CHARSET=utf8;
...
) ENGINE=MyISAM AUTO_INCREMENT=11838 DEFAULT CHARSET=utf8;
...
) ENGINE=MyISAM AUTO_INCREMENT=11902 DEFAULT CHARSET=utf8;
...
`log_id` int(11) NOT NULL,
  ...
  `msg` text NOT NULL,
  `time_stamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=MyISAM AUTO_INCREMENT=940321 DEFAULT CHARSET=utf8;
...
`package_id` int(11) NOT NULL,
  ...
  `active` tinyint(1) NOT NULL,
  `time_stamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=MyISAM AUTO_INCREMENT=18380 DEFAULT CHARSET=utf8 COMMENT='Packages main table (P)';
...
`id` int(11) NOT NULL,
  `package_id` int(11) NOT NULL,
  `email_id` int(11) NOT NULL
) ENGINE=MyISAM AUTO_INCREMENT=22156 DEFAULT CHARSET=utf8;
...
`id` int(11) NOT NULL,
  `package_id` int(11) NOT NULL,
  `checksum` varchar(100) NOT NULL
) ENGINE=MyISAM AUTO_INCREMENT=18379 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='Repo main table (repo)';
...
) ENGINE=MyISAM AUTO_INCREMENT=6124 DEFAULT CHARSET=utf8 COMMENT='Use flags main table';
...
--
ALTER TABLE `build_jobs`
MODIFY `build_job_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3114;
--
...
--
ALTER TABLE `build_jobs_use`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=14697;
--
-- AUTO_INCREMENT for table `build_logs`
--
ALTER TABLE `build_logs`
MODIFY `build_log_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10892;
--
-- AUTO_INCREMENT for table `build_logs_config`
--
ALTER TABLE `build_logs_config`
MODIFY `log_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=37427;
--
...
--
ALTER TABLE `build_logs_hilight`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=249211;
--
...
--
ALTER TABLE `build_logs_use`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=47834;
--
...
--
ALTER TABLE `ebuilds`
MODIFY `ebuild_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=70672;
--
-- AUTO_INCREMENT for table `ebuilds_iuse`
--
ALTER TABLE `ebuilds_iuse`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=374659;
--
-- AUTO_INCREMENT for table `ebuilds_keywords`
--
ALTER TABLE `ebuilds_keywords`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=473503;
--
-- AUTO_INCREMENT for table `ebuilds_metadata`
--
ALTER TABLE `ebuilds_metadata`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=70672;
--
-- AUTO_INCREMENT for table `ebuilds_restrictions`
--
ALTER TABLE `ebuilds_restrictions`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=11838;
--
-- AUTO_INCREMENT for table `emails`
--
ALTER TABLE `emails`
MODIFY `email_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=669;
--
-- AUTO_INCREMENT for table `emerge_info`
--
ALTER TABLE `emerge_info`
MODIFY `einfo_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=11902;
--
...
--
ALTER TABLE `logs`
MODIFY `log_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=940321;
--
-- AUTO_INCREMENT for table `packages`
--
ALTER TABLE `packages`
MODIFY `package_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=18380;
--
-- AUTO_INCREMENT for table `packages_emails`
--
ALTER TABLE `packages_emails`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=22156;
--
-- AUTO_INCREMENT for table `packages_metadata`
--
ALTER TABLE `packages_metadata`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=18379;
--
...
--
ALTER TABLE `restrictions`
MODIFY `restriction_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=54;
--
-- AUTO_INCREMENT for table `uses`
--
ALTER TABLE `uses`
MODIFY `use_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6124;
DELIMITER $$
--
-- Events
--
CREATE DEFINER=`zobcs`@`localhost` EVENT `add_esync_jobs` ON SCHEDULE EVERY 1 HOUR STARTS '2012-12-23 17:15:13' ON COMPLETION NOT PRESERVE ENABLE DO BEGIN
  CALL add_jobs_esync();
END$$
